...
//│ U max: 63, total: 470
//│ UERR 3 errors
//│ L: 1 [int ~ ([α197''], [α198''],), int :> α189'', [α189'' - (α189'' -> (α190'' -> [int])) ~ (α187'' -> (α188'' -> α187'')) - α187'', L: 0 [(α189'' -> (α190'' -> [int])) ~ (α187'' -> (α188'' -> α187'')), (α189'' -> (α190'' -> [int])) <: (α187'' -> (α188'' -> α187''))]], α187'' <: ([α197''], [α198''],)]
//│ L: 0 [int ~ ([α197''], [α198''],), int <: α187'', α187'' <: ([α197''], [α198''],)]
//│ L: 2 [int ~ ([α197''], [α198''],), [int - (α190'' -> [int]) ~ (α188'' -> α187'') - α187'', L: 1 [(α190'' -> [int]) ~ (α188'' -> α187''), [(α190'' -> [int]) - (α189'' -> (α190'' -> [int])) ~ (α187'' -> (α188'' -> α187'')) - (α188'' -> α187''), L: 0 [(α189'' -> (α190'' -> [int])) ~ (α187'' -> (α188'' -> α187'')), (α189'' -> (α190'' -> [int])) <: (α187'' -> (α188'' -> α187''))]]]], α187'' <: ([α197''], [α198''],)]
