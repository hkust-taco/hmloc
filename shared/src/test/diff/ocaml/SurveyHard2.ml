...
//│ U max: 28, total: 228
//│ UERR 2 errors
//│ L: 0 [int ~ ([α242''], [α243''],), int <: α233'', α233'' <: ([α242''], [α243''],)]
//│ L: 2 [int ~ ([α242''], [α243''],), [int - (α236'' -> [int]) ~ (α234'' -> α233'') - α233'', L: 1 [(α236'' -> [int]) ~ (α234'' -> α233''), [(α236'' -> [int]) - (α235'' -> (α236'' -> [int])) ~ (α233'' -> (α234'' -> α233'')) - (α234'' -> α233''), L: 0 [(α235'' -> (α236'' -> [int])) ~ (α233'' -> (α234'' -> α233'')), (α235'' -> (α236'' -> [int])) <: (α233'' -> (α234'' -> α233''))]]]], α233'' <: ([α242''], [α243''],)]
