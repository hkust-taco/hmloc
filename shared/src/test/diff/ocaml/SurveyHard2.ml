...
//│ U max: 31, total: 257
//│ UERR 3 errors
//│ L: 1 [int ~ ([α243''], [α244''],), int :> α235'', [α235'' - (α235'' -> (α236'' -> [int])) ~ (α233'' -> (α234'' -> α233'')) - α233'', L: 0 [(α235'' -> (α236'' -> [int])) ~ (α233'' -> (α234'' -> α233'')), (α235'' -> (α236'' -> [int])) <: (α233'' -> (α234'' -> α233''))]], α233'' <: ([α243''], [α244''],)]
//│ L: 2 [int ~ ([α243''], [α244''],), [int - (α236'' -> [int]) ~ (α234'' -> α233'') - α233'', L: 1 [(α236'' -> [int]) ~ (α234'' -> α233''), [(α236'' -> [int]) - (α235'' -> (α236'' -> [int])) ~ (α233'' -> (α234'' -> α233'')) - (α234'' -> α233''), L: 0 [(α235'' -> (α236'' -> [int])) ~ (α233'' -> (α234'' -> α233'')), (α235'' -> (α236'' -> [int])) <: (α233'' -> (α234'' -> α233''))]]]], α233'' <: ([α243''], [α244''],)]
//│ L: 0 [int ~ ([α243''], [α244''],), int <: α233'', α233'' <: ([α243''], [α244''],)]
