...
//│ U max: 55, total: 154
//│ UERR 2 errors
//│ L: 0 [list['a175'] ~ ([α195'], [α196'],), list['a175'] <: α173', α173' :> α169', [α169' - (α169' -> α170') ~ (α201' -> α200') - α201', L: 1 [(α169' -> α170') ~ (α201' -> α200'), [(α169' -> α170') - (α168' -> (α169' -> α170')) ~ (α200' -> (α201' -> α200')) - (α201' -> α200'), L: 0 [(α168' -> (α169' -> α170')) ~ (α200' -> (α201' -> α200')), (α168' -> (α169' -> α170')) <: (α200' -> (α201' -> α200'))]]]], [α201' - list[α201'] ~ list[α194'] - α194', L: 0 [list[α201'] ~ list[α194'], list[α201'] :> list[α194']]], [α194' - list[α194'] ~ list[([α195'], [α196'],)] - ([α195'], [α196'],), L: 0 [list[α194'] ~ list[([α195'], [α196'],)], list[α194'] :> list[([α195'], [α196'],)]]]]
