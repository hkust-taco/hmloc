...
//│ U max: 55, total: 154
//│ UERR 2 errors
//│ L: 0 [list['a177'] ~ (α197', α198',), list['a177'] <: α175', α175' :> α171', [α171' - (α171' -> α172') ~ (α203' -> α202') - α203', L: 1 [(α171' -> α172') ~ (α203' -> α202'), [(α171' -> α172') - (α170' -> (α171' -> α172')) ~ (α202' -> (α203' -> α202')) - (α203' -> α202'), L: 0 [(α170' -> (α171' -> α172')) ~ (α202' -> (α203' -> α202')), (α170' -> (α171' -> α172')) <: (α202' -> (α203' -> α202'))]]]], [α203' - list[α203'] ~ list[α196'] - α196', L: 0 [list[α203'] ~ list[α196'], list[α203'] :> list[α196']]], [α196' - list[α196'] ~ list[(α197', α198',)] - (α197', α198',), L: 0 [list[α196'] ~ list[(α197', α198',)], list[α196'] :> list[(α197', α198',)]]]]
//│ L: 0 [list['a177'] ~ ([α183'], [α184'],), list['a177'] <: α175', α175' :> α171', α171' <: ([α183'], [α184'],)]
