...
//│ ║  l.+1: 	(add add)
//│ ║        	 ^^^^^^^
//│ ╟── reference of type `int -> int -> int` is not an instance of `int`
//│ ║  l.+1: 	(add add)
//│ ╙──      	     ^^^
//│ res: int -> int
...
//│ ║  l.+1: 	(add 0.v)
//│ ║        	      ^^
//│ ╟── integer literal of type `int` does not have field 'v'
//│ ║  l.+1: 	(add 0.v)
//│ ╙──      	     ^
//│ res: int -> int
...
//│ ║  l.+1: 	(add {v: 0})
//│ ║        	 ^^^^^^^^^^
//│ ╟── record of type `{v: int}` is not an instance of `int`
//│ ║  l.+1: 	(add {v: 0})
//│ ╙──      	     ^^^^^^
//│ res: int -> int
...
//│ ║  l.+1: 	(add {v: add})
//│ ║        	 ^^^^^^^^^^^^
//│ ╟── record of type `{v: int -> int -> int}` is not an instance of `int`
//│ ║  l.+1: 	(add {v: add})
//│ ╙──      	     ^^^^^^^^
//│ res: int -> int
...
//│ ║  l.+1: 	(add {v: 0.v})
//│ ║        	 ^^^^^^^^^^^^
//│ ╟── record of type `{v: ?v}` is not an instance of `int`
//│ ║  l.+1: 	(add {v: 0.v})
//│ ╙──      	     ^^^^^^^^
//│ res: int -> int
...
//│ ║  l.+1: 	((let x = 0; add) (x => 0))
//│ ║        	 ^^^^^^^^^^^^^^^^^^^^^^^^^
//│ ╟── function of type `?a -> int` is not an instance of `int`
//│ ║  l.+1: 	((let x = 0; add) (x => 0))
//│ ║        	                   ^^^^^^
...
//│ ║        	 ^^^^^^^^^^^^^^^^^^^^^^^^^^^
//│ ╟── function of type `?a -> int -> int -> int` is not an instance of `int`
//│ ║  l.+1: 	((let x = 0; add) (x => add))
//│ ║        	                   ^^^^^^^^
//│ ╟── but it flows into argument with expected type `int`
//│ ║  l.+1: 	((let x = 0; add) (x => add))
...
//│ ║  l.+1: 	((let x = 0; add) (x => x))
//│ ║        	 ^^^^^^^^^^^^^^^^^^^^^^^^^
//│ ╟── function of type `?a -> ?a` is not an instance of `int`
//│ ║  l.+1: 	((let x = 0; add) (x => x))
//│ ║        	                   ^^^^^^
//│ ╟── but it flows into argument with expected type `int`
//│ ║  l.+1: 	((let x = 0; add) (x => x))
...
//│ ║  l.+1: 	((let x = 0; add) {u: 0})
//│ ║        	 ^^^^^^^^^^^^^^^^^^^^^^^
//│ ╟── record of type `{u: int}` is not an instance of `int`
//│ ║  l.+1: 	((let x = 0; add) {u: 0})
//│ ╙──      	                  ^^^^^^
//│ res: int -> int
...
//│ ║        	 ^^^^^^^^^^^^^^^^^^^^^^^^^
//│ ╟── record of type `{u: int -> int -> int}` is not an instance of `int`
//│ ║  l.+1: 	((let x = 0; add) {u: add})
//│ ╙──      	                  ^^^^^^^^
//│ res: int -> int
...
//│ ║  l.+1: 	((let rec x = x; add) {v: 0.u})
//│ ║        	 ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
//│ ╟── record of type `{v: ?u}` is not an instance of `int`
//│ ║  l.+1: 	((let rec x = x; add) {v: 0.u})
//│ ╙──      	                      ^^^^^^^^
//│ res: int -> int
...
//│ ║        	 ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
//│ ╟── application of type `int -> int` is not an instance of `int`
//│ ║  l.+1: 	((let x = {v: 0}; add) (add 0))
//│ ║        	                        ^^^^^
//│ ╟── but it flows into argument with expected type `int`
//│ ║  l.+1: 	((let x = {v: 0}; add) (add 0))
...
//│ ║        	                               ^^
//│ ╟── function of type `?a -> int` does not have field 'v'
//│ ║  l.+1: 	((let x = {v: 0}; add) (x => 0).v)
//│ ║        	                        ^^^^^^
...
//│ ║  l.+1: 	(let x = {v: 0}.u; x)
//│ ║        	               ^^
//│ ╟── record of type `{v: int}` does not have field 'u'
//│ ║  l.+1: 	(let x = {v: 0}.u; x)
//│ ╙──      	         ^^^^^^
//│ res: nothing
...
(x => {u: 0, v: add})
//│ res: anything -> {u: int, v: int -> int -> int}
...
{u: 0, v: (x => add)}
//│ res: {u: int, v: anything -> int -> int -> int}
...
{u: 0, v: {u: 0, v: 0}}
//│ res: {u: int, v: {u: int, v: int}}

{u: 0, v: {u: 0, v: add}}
//│ res: {u: int, v: {u: int, v: int -> int -> int}}

{u: 0, v: {u: add}}
//│ res: {u: int, v: {u: int -> int -> int}}

{u: 0, v: {v: 0}}
//│ res: {u: int, v: {v: int}}

{u: 0, v: {v: add}}
//│ res: {u: int, v: {v: int -> int -> int}}
...
{u: add, v: {u: 0}}
//│ res: {u: int -> int -> int, v: {u: int}}

{u: add, v: {u: add}}
//│ res: {u: int -> int -> int, v: {u: int -> int -> int}}

{u: add, v: {u: add, v: 0}}
//│ res: {u: int -> int -> int, v: {u: int -> int -> int, v: int}}

{u: add, v: {u: add, v: add}}
//│ res: {u: int -> int -> int, v: {u: int -> int -> int, v: int -> int -> int}}

{u: add, v: {u: (x => 0)}}
//│ res: {u: int -> int -> int, v: {u: anything -> int}}

{u: add, v: {u: (x => add)}}
//│ res: {u: int -> int -> int, v: {u: anything -> int -> int -> int}}

{u: add, v: {u: (x => add), v: 0}}
//│ res: {u: int -> int -> int, v: {u: anything -> int -> int -> int, v: int}}
...
//│ ║  l.+1: 	{u: add, v: {u: 0}.v}
//│ ║        	                  ^^
//│ ╟── record of type `{u: int}` does not have field 'v'
//│ ║  l.+1: 	{u: add, v: {u: 0}.v}
//│ ╙──      	            ^^^^^^
//│ res: {u: int -> int -> int, v: nothing}
...
{u: {u: 0}, v: add}
//│ res: {u: {u: int}, v: int -> int -> int}

{u: {u: 0}, v: (add 0)}
//│ res: {u: {u: int}, v: int -> int}
...
{u: {u: 0}, v: (x => 0)}
//│ res: {u: {u: int}, v: anything -> int}

{u: {u: 0}, v: (x => add)}
//│ res: {u: {u: int}, v: anything -> int -> int -> int}
...
//│ ║  l.+1: 	{u: {u: 0}, v: (x => 0.u)}
//│ ╙──      	                     ^
//│ res: {u: {u: int}, v: anything -> nothing}
...
{u: {u: add}, v: 0}
//│ res: {u: {u: int -> int -> int}, v: int}

{u: {u: add}, v: add}
//│ res: {u: {u: int -> int -> int}, v: int -> int -> int}

{u: {u: add}, v: (x => 0)}
//│ res: {u: {u: int -> int -> int}, v: anything -> int}
...
{u: {v: 0}, v: (x => add)}
//│ res: {u: {v: int}, v: anything -> int -> int -> int}
